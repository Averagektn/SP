...
extern "C" _declspec(dllexport) void __stdcall drawEllipticalText(HDC hdc, const wchar_t* text, POINT center, int vDiameter, int hDiameter, int letterHeight, int ind = 0)
{
	XFORM xForm;
